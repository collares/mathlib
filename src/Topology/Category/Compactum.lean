...
-- ././Mathport/Syntax/Translate/Basic.lean:598:2: warning: expanding binder collection (B C «expr ∈ » C0)
...
-- ././Mathport/Syntax/Translate/Basic.lean:598:2: warning: expanding binder collection (S1 S2 «expr ∈ » T0)
